...
//     address: string
// }
// const person1: Person = { id: 123, name: 'Moshe', address: 'Rishon' };
//
// interface IPerson {
//     id: number,
//     name: string
...
//     salary: number
// }
// const employee1: Employee = { id: 123, name: 'Moshe', salary: 10000, address: 'Rishon' };
...
class Canvas implements Shape {
    ...
    draw(): void {
        //TODO write method draw for all drawing all shapes in the canvas
    }
    ...
    removeShape(index: number): Shape {
        ...
        //return reference to the removed shape
    ...
    removeIf(predicate: (shape: Shape) => boolean) {
        ...
        //TODO remove all lines having the property x of second point greater than property x of first point
    }
